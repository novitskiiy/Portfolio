...
const ExperienceInfo = [
    {
        ...
        desc: "I worked as a Java Developer on the Data Management Module, a system for integrating and standardizing product and customer data from multiple external sources. I developed microservices with Java and Spring WebFlux, worked with Oracle and PostgreSQL databases, and built REST APIs for data exchange. This improved data processing speed by about 30% and reduced errors during integration. I also optimized SQL queries, set up CI/CD pipelines with Jenkins and SonarCube, and increased unit test coverage to around 70%. My role involved close collaboration with frontend developers and active participation in Scrum ceremonies, which helped me gain strong experience in microservices, data integration, and team-based development.",
        skills: ["Java", "Spring Boot", "Spring WebFlux", "Spring Data", "JDBC", "REST APIs", "PostgreSQL", "Microservices", "Git", "Maven", "Jenkins", "SonarCube", "JUnit", "Mockito"]
    },
    {
        role: "Intern Java",
        company: "SoftServe",
